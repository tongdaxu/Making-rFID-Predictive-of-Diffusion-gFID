...
EVAL_PY="${EVAL_PY:-$REPO/eval_proxy_dinocos.py}"
...
echo 'model,exp_path,setting,dino_patch_cos,dino_patch_dist,dino_global_cos,dino_global_dist,status' > "$SUMMARY_LONG"
