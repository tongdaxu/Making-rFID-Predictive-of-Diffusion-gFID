...
OUT="/share/xutongda/REPA-E/exps_interpolate/local_score_single/sdvae_model_vs_local_multistep_xpred_crossclass50k_${P_MODE}"
mkdir -p "$OUT"

CUDA_VISIBLE_DEVICES=0 python eval_sdvae_model_vs_local_score_multistep_xpred.py \
