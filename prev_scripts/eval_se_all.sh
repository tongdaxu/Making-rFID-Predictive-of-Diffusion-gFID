...
CONFIG_DIR="./configs"
LOG_DIR="/video_ssd/kongzishang/xutongda/git/IFID/losses/se"
...
for ((i=0; i<${#CONFIGS[@]}; i++)); do
  ...
  OUT_FILE="${LOG_DIR}/eval_se_${NAME_LOWER}.out"

  echo "Launching eval_se.py with ${CONFIG} on GPU ${GPU_ID}, port ${PORT}"
  echo "Log: ${OUT_FILE}"
...
echo "All eval_se jobs finished."