...
def get_psnr(x_input, x_recon, zero_mean=False, is_video=False, integer=False):
    if zero_mean:
    ...
    if integer:
        x_input_0_255 = torch.round(x_input_0_255)
        x_recon_0_255 = torch.round(x_recon_0_255)
