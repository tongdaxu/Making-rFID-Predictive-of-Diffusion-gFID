...
from ifid.loss.perceptual_loss import PerceptualLoss
from ifid.loss.discriminator import NLayerDiscriminator, weights_init
...
class ReconstructionLoss_Simple(ReconstructionLoss_Stage2):
    def __init__(
        self,
        config
    ):
