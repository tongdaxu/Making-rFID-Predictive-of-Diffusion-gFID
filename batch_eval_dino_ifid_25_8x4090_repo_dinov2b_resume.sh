...
NN_CACHE="${NN_CACHE:-/share/xutongda/REPA-E/exps_interpolate/dino_ifid_25/dinov2_vitb_global_ref50000_val50000}"
...
OUT_TAG="${OUT_TAG:-dinov2_vitb_global_cos_top1_slerp_a05_50k50k}"
...
launch_job() {
  ...
  echo "Launching ${cfg} on RTX 4090 GPU ${gpu}: bs=${bs}, shared repo-DINOv2-B pairs, ref=${REF_SIZE}, val=${VAL_SIZE}"
