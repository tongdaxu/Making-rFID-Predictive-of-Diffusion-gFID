...
JOBS=(
  "EQ-VAE|EQVAE.yaml|eqvae"
  "IN-VAE|INVAE.yaml|invae"
  "VA-VAE|VAVAE.yaml|vavae"
  "VA-VAE-64|VAVAE64.yaml|vavae64"
  "RAE|RAE.yaml|rae"
  "FLUX2-VAE|FLUX2VAE.yaml|flux2"
  "SVG|SVG.yaml|svg"
  "UAE|UAE.yaml|uae"
  "ScaleRAE-SigLIP2|ScaleRAE_SIGLIP2_NONORM.yaml|scalerae-siglip2"
  "ScaleRAE-WEBSSL|ScaleRAE_WEBSSL.yaml|scalerae-webssl"
  "SVG-T2I-P-256|SVGT2I_P_STAGE1_256.yaml|svg-t2i-p256"
  "DCAE|DCAE.yaml|dcae"
  "PAE-DINO|PAE_DINOv2L_d32.yaml|pae-dino"
)
