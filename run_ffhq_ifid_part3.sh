...
JOBS=(
  "RAE|RAE.yaml|ffhq-ifid-rae"
  "FLUX2-VAE|FLUX2VAE.yaml|ffhq-ifid-flux2"
  "SVG|SVG.yaml|ffhq-ifid-svg"
  "UAE|UAE.yaml|ffhq-ifid-uae"
  "ScaleRAE-SigLIP2|ScaleRAE_SIGLIP2_NONORM.yaml|ffhq-ifid-scalerae-siglip2"
)

echo "============================================================"
echo "[FFHQ IFID PART 3]"
...
echo "All FFHQ IFID PART 3 jobs finished."
