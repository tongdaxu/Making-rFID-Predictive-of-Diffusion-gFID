...
# -*- coding: utf-8 -*-
"""
Run OpenAI guided-diffusion evaluator and save:
  Inception Score, FID, sFID, Precision, Recall

This is intentionally a thin wrapper around openai/guided-diffusion/evaluations/evaluator.py.
"""
...
def import_guided_evaluator(guided_diffusion_dir: str):
    ...
    import evaluator as gd_eval  # noqa
    return gd_eval
