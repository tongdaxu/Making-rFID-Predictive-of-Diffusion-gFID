...
SCRIPT="${SCRIPT:-eval_local_ifid_p1_global_slerp_25_fast.py}"
...
OUT_TAG="${OUT_TAG:-localnn_p1_global_${INTP}_a05_${REF_SIZE}x${VAL_SIZE}}"
OUT_ROOT="${OUT_ROOT:-/share/xutongda/REPA-E/exps_interpolate/local_ifid_p1_global_interp_25/${OUT_TAG}}"
