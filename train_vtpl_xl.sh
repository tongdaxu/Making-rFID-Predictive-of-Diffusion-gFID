...
CUDA_VISIBLE_DEVICES=4,5,6,7 nohup accelerate launch --num_processes=4 --main_process_port=29504 train.py \
    ...
    --vae-config="./configs/VTPL.yaml" \
    --bn-momentum=0.1 \
    --exp-name="sit-xl-vtpl-400k" \
    &> sit-xl-vtpl-400k.out &
