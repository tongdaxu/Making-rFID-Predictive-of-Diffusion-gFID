...
v6 adds optional GPU-resident full-reference hidden storage for 80 GiB A800 GPUs.
For 50k x 256 x 1152 FP16 reference hidden, this uses about 27.5 GiB and
removes random disk/CPU transfers from query-time reranking.
"""
...
def evaluate_queries(
    ...
    return {
        "settings": {
            ...
            "retrieval_protocol": "full_hidden_signed_hash_topk_then_exact_full_rerank",
            "coarse_representation": "signed_hash_of_all_TxD_hidden_coordinates_no_pool",
...
def main() -> None:
    ...
    print("\n=== Hidden interpolation metrics (full-hidden sketch retrieval) ===")
