...
LOG_DIR="${LOG_DIR:-${ROOT}/logs_ifid_save}"
...
MASTER_PORT="${MASTER_PORT:-$((29720 + PART_ID))}"
...
echo "================================================================================"
echo "[iFID rerun with saved interpolate images]"
echo "ROOT=${ROOT}"
...
for i in "${!SELECTED[@]}"; do
  ...
  echo "  selected_index=$((i + 1)) ${NAME} ${CONFIG_FILE}"
done
echo
