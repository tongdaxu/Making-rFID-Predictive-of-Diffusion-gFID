...
JOBS=(
  "SD-VAE|SDVAE.yaml|sdvae"
  "FLUX-VAE|FLUXVAE.yaml|fluxvae"
  "QwenImg-VAE|QWVAE.yaml|qwenimgvae"
  "SD3-VAE|SD3VAE.yaml|sd3vae"
  "SOFT-VQ|SOFTVQ.yaml|softvq"
  "MAE-TOK|MAETOK.yaml|maetok"
