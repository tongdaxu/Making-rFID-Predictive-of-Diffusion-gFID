...
JOBS=(
  # "ScaleRAE-WEBSSL|ScaleRAE_WEBSSL.yaml|ffhq-ifid-scalerae-webssl"
  # "SVG-T2I-P-256|SVGT2I_P_STAGE1_256.yaml|ffhq-ifid-svg-t2i-p256"
  # "DCAE|DCAE.yaml|ffhq-ifid-dcae"
  # "PAE-DINO|PAE_DINOv2L_d32.yaml|ffhq-ifid-pae-dino"
  "DE-TOK|DETOK.yaml|ffhq-ifid-detok"
  "DM-VAE|DMVAE.yaml|ffhq-ifid-dmvae"
)

echo "============================================================"
echo "[FFHQ IFID PART 4]"
...
echo "All FFHQ IFID PART 4 jobs finished."
