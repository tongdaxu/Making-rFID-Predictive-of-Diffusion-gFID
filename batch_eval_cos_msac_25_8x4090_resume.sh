...
SCRIPT="${SCRIPT:-eval_cos_msac_25_4090.py}"
CONFIG_DIR="${CONFIG_DIR:-./configs}"

GPU_LIST=(${GPU_LIST:-0 1 2 3 4 5 6 7})
HIGH_GPU_LIST=(${HIGH_GPU_LIST:-0})
...
DEFAULT_REF_CHUNK="${DEFAULT_REF_CHUNK:-1024}"
HIGH_REF_CHUNK="${HIGH_REF_CHUNK:-16}"

OUT_ROOT="${OUT_ROOT:-$REPO/cos_msac_results/cos_midpoint_hardcos_slerp_a05_50k50k}"
...
run_phase() {
  ...
  launch() {
    ...
    echo "Launching ${cfg} on RTX4090 GPU ${gpu}: bs=${bs}, ref_chunk=${ref_chunk}"
